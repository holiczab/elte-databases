...
![alt text](../assets/collection.png){ width=700 }

# Data models

![alt text](../assets/data_model.png){ width=700 }

# Entity Relationship Model

Create an entity relationship diagram frombusiness specifications or narratives:

![alt text](../assets/entity.png){ width=700 }
...
![alt text](../assets/entity2.png){ width=700 }
...
![alt text](../assets/tables.png){ width=700 }

# Relational Database Terminology

![alt text](../assets/structure.png){ width=700 }
...
![alt text](../assets/comm.png){ width=700 }

# SQL Statements

![alt text](../assets/statement_elements.png){ width=700 }

# Order of Statements

![alt text](../assets/order.png){ width=700 }

# Tables Used in the Course

![alt text](../assets/used_tables.png){ width=700 }

# Capabilities of SQL SELECT Statements

![alt text](../assets/cap.png){ width=700 }
